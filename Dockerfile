...
#   Build:  pip install -r render-requirements.txt && ./render-build.sh
...
# Frontend dist is copied next to the backend modules so StaticFiles can
# serve it; start.sh decides whether a pre-built dist exists.
